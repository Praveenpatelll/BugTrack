        ...
        <div>
            <div className="page-header">
                <div className="page-title-group">
                    ...
                    <p>Manage users, roles, and access controls.</p>
                </div>
            ...
            {/* Tabs */}
            {/* Tabs */}
            <div className="nav-tabs" style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem', borderBottom: '1px solid var(--border-color)' }}>
                <button
